...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // database name
    protected static final String DATABASE_NAME = "charity.db";

    // table details
    public String tableName = "mycharity";
    public String fieldObjectId = "id";
    public String fieldObjectName = "name";
    public String fieldObjectBn = "bn";
    ...
    public boolean create(MyObject myObj) {
        ...
        if(!checkIfExists(myObj.objectName)){
            ...
            values.put(fieldObjectBn, myObj.objectBn);
